		...
		if(!empty($_POST["quantity"])) {
			...
			if(!empty($_SESSION["cart_item"])) {
				...
				if(in_array($productByCode[0]["code"],array_keys($_SESSION["cart_item"]))) {
					//daca nu exista produsul deja in cos
...
<div id="header" align="left"><a style="background:DeepSkyBlue" href="login.php?q=login">LOGIN clienti Lidl</a></div>
<br>
<div id="header" align="left" ><a style="background:yellow" href="loginadmin.php">LOGIN angajati Lidl</a></div>
<div id="shopping-cart">
<div class="txt-heading">Cosul meu</div>

<a id="btnEmpty" href="index.php?action=finalizare">Finalizare cumparaturi</a>
...
<?php
    ...
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="index.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="delete.jpg" alt="Remove Item" /></a></td>
				</tr>
				<?php
...
?>
<div class="no-records">Cosul este gol acum</div>
<?php
}
?>
</div>
